...
<html <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<div class="content" role="main">
			<section class="welcome" data-bg-image="<?php bloginfo(template_url); ?>/assets/images/colony/<?php echo str_pad(rand(1, 16), 2, "0", STR_PAD_LEFT); ?>.jpg" data-fill>
				<div class="effect">
			...
			<section class="section featured-projects">
				<div class="effect">
					<h2>Our Projects</h2>
					<?php query_posts('category_name=makes&tag=featured&posts_per_page=2'); ?>
					<?php if ( have_posts() ) : ?>
						<ul class="float-clear">
							<?php while ( have_posts() ) : the_post(); ?>
					   		...
					   		<?php else : ?>
									<li class="project-post float-left" data-bg-image="<?php bloginfo(template_url); ?>/assets/images/colony/<?php echo str_pad(rand(1, 16), 2, "0", STR_PAD_LEFT); ?>.jpg">
								<?php endif; ?>
					   			<div class="effect">
					...
					<?php if ( have_posts() ) : ?>
						<ul class="float-clear">
							<?php while ( have_posts() ) : the_post(); ?>
					   		...
					   		<?php else : ?>
									<li class="client-post float-left" data-bg-image="<?php bloginfo(template_url); ?>/assets/images/colony/<?php echo str_pad(rand(1, 16), 2, "0", STR_PAD_LEFT); ?>.jpg">
								<?php endif; ?>
					   			<div class="effect">
								  <div class="post-chapter">
										N°<?php the_ID(); ?>,<?php the_date( 'm/Y' ); ?> 
					...
					<?php if ( have_posts() ) : ?>
						<ul class="float-clear">
							<?php while ( have_posts() ) : the_post(); ?>
					   		...
					   		<?php else : ?>
									<li class="blog-post float-left" data-bg-image="<?php bloginfo(template_url); ?>/assets/images/colony/<?php echo str_pad(rand(1, 16), 2, "0", STR_PAD_LEFT); ?>.jpg">
								<?php endif; ?>
									<div class="effect">
								  <div class="post-chapter">
										N°<?php the_ID(); ?>,<?php the_date( 'm/Y' ); ?> 
